...
public static class EndOfRoundPrinter
{
    ...
    private static string CreateEndOfRoundItemText(GameState gameState, RoundUpdateResultItem item) => item switch
    {
        ...
        PlayerHenchmenPaid playerHenchmenPaid => string.Format(
            ...
            playerHenchmenPaid.NumberOfHenchmenPaid,
            playerHenchmenPaid.DailyPayRate,
            playerHenchmenPaid.TotalPaidAmount
        ),
        PlayerHenchmenQuit playerHenchmenQuit => string.Format(
            PlayerHenchmenQuitFormatString,
            playerHenchmenQuit.NumberOfHenchmenQuit,
            gameState.Players[playerHenchmenQuit.PlayerIndex].Identification.Name
        ),
