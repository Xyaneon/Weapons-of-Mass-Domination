...
namespace WMD.Console.UI.Commands
{
    class ChangeDailyWageInputRetriever : ICommandInputRetriever
    {
        ...
        private const string GetNewDailyWagePromptFormatString = "You currently pay your henchmen {0:C} each every day. Please enter the new amount ({1:C} to {2:C})";
        ...
        public CommandInput? GetCommandInput(GameState gameState)
        {
            ...
            var prompt = string.Format(GetNewDailyWagePromptFormatString, currentDailyWage, allowedSpendingAmounts.Minimum, allowedSpendingAmounts.Maximum);
