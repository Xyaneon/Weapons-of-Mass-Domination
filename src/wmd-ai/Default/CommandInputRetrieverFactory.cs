...
{
    internal static class CommandInputRetrieverFactory
    {
        private const string ArgumentException_commandInputTypeNotRecognized = "Command input type not recognized.";

        public static ICommandInputRetriever CreateICommandInputRetriever(Type commandInputType)
        {
            return commandInputType switch
            {
